...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        // The request is not already in flight. Send the news request to the network and
        // track it.
    ...
    private class BatchedImageRequest {
        ...
        /**
         * Constructs a news BatchedImageRequest object
    ...
    private void batchResponse(String cacheKey, BatchedImageRequest request) {
        ...
        // If we don't already have a batch delivery runnable in flight, make a news one.
