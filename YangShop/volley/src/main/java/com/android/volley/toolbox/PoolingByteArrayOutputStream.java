...
public class PoolingByteArrayOutputStream extends ByteArrayOutputStream {
    ...
    /**
     * Constructs a news PoolingByteArrayOutputStream with a default size. If more bytes are written
    ...
    /**
     * Constructs a news {@code ByteArrayOutputStream} with a default size of {@code size} bytes. If
